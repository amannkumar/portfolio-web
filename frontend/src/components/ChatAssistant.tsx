...
import { chatService, QUICK_QUESTIONS } from "@/lib/chatService";
      ...
      setMessages([
        {
          role: "assistant",
          content:
            "Hi! I can answer questions about Aman's experience, projects, skills, recent activity, and background. What would you like to know?",
          timestamp: new Date(),
        },
      ]);
    }
    ...
    try {
      ...
      const interval = setInterval(() => {
        setMessages((prev) => {
          ...
          lastMessage.content = reply.slice(0, index + 1);
          return updated;
        });
      ...
      setMessages((prev) => [
        ...prev,
        {
          role: "assistant",
          content:
            "Sorry, something went wrong. Please try again or reach out to Aman directly via Linkedin - https://www.linkedin.com/in/aamankumar/",
          timestamp: new Date(),
        },
      ]);
    } finally {
            ...
            <>
              ...
              >
                <div className="relative z-10">
                  <p className="text-xs font-medium text-foreground/90 leading-relaxed">
                    ✨ Discover why{" "}
                    <span className="text-primary font-bold bg-primary/10 px-1 py-0.5 rounded">
                      Aman
                    </span>{" "}
              ...
              >
                ...
                <Button
                  onClick={toggleChat}
                  size="lg"
                  className="h-16 w-16 rounded-full bg-gradient-to-r from-emerald-400 via-green-500 to-emerald-600 hover:opacity-90 shadow-[var(--shadow-elegant)] group relative overflow-hidden z-10 border-2 border-white/20"
                >
                  <motion.div
              ...
              <div className="p-4 border-t border-border/50 bg-background/80 backdrop-blur-sm">
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    size="sm"
                    className="px-4 h-12 bg-gradient-to-r from-primary to-accent hover:opacity-90 rounded-full"
                  >
                    {isLoading ? (
