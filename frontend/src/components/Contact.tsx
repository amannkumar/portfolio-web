...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      value: "+1 514 943 6119",
      link: "tel:+15149436119",
    },
    {
      icon: Mail,
      title: "Email Address",
      value: "amankumar.dev3895@gmail.com",
      link: "mailto:amankumar.dev3895@gmail.com",
    },
  ];
  ...
  const socials = [
    {
      icon: FaLinkedin,
      label: "LinkedIn",
      link: "https://www.linkedin.com/in/aamankumar/",
    },
    {
      icon: FaXTwitter,
      label: "Twitter",
      link: "https://x.com/amannnkumar",
    },
    {
      icon: FaGithub,
      label: "GitHub",
      link: "https://github.com/amannkumar",
    },
    {
      icon: SiLeetcode,
      label: "LeetCode",
      link: "https://leetcode.com/u/amannkumar/",
    },
  ];
